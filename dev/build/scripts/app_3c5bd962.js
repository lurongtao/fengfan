      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www.mobiletrain.org/about/?", target: "_blank" },
              "\u5173\u4E8E\u5343\u950B"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www.mobiletrain.org/about/contact.html?", target: "_blank" },
              "\u8054\u7CFB\u6211\u4EEC"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www.mobiletrain.org/cooperation/?", target: "_blank" },
              "\u4F01\u4E1A\u5408\u4F5C"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www.mobiletrain.org/about/job.html?", target: "_blank" },
              "\u62DB\u8D24\u7EB3\u58EB"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www8.53kf.com/webCompany.php?style=3&arg=10132404", target: "_blank" },
              "\u62A5\u540D\u54A8\u8BE2"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www.mobiletrain.org/video/?", target: "_blank" },
              "\u6559\u5B66\u89C6\u9891"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://www.mobiletrain.org/lecture/?", target: "_blank" },
              "\u5B66\u4E60\u8D44\u6599"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://bbs.mobiletrain.org/forum.php?", target: "_blank" },
              "\u6280\u672F\u8BBA\u575B"
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "a",
              { href: "http://list.qq.com/cgi-bin/qf_invite?id=b8dbe50f0720fbac13c01a3164cddf60ec63557f6d474ee9&" },
              "RSS\u8BA2\u9605"
            )
          )
        ),
...
var qandaList = function (_React$Component) {
  ...
  function qandaList(props) {
    ...
    _this.getData({
      ...
      var filterData = _tagFilter2.default.dataProcessing(listDa, '所有标签');
      _this.setState({
        data: listDa,
  ...
  _createClass(qandaList, [{
    ...
    value: function pageChange(page) {
      ...
      this.getData({
        ...
        var filterData = _tagFilter2.default.dataProcessing(listDa, _this3.state.curTag);
        _this3.setState({
          data: listDa,
          filterData: filterData
        });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_antd.Pagination, { defaultCurrent: 1, defaultPageSize: this.state.count, total: this.state.total ? this.state.total : 1, onChange: this.pageChange.bind(this) })
        )
      );
    }
  }, {
	...
	_createClass(Resetpwd, [{
		...
		value: function repwd() {
			...
			if (username != '' && newpwd != '' && newpwd == confirmpwd) {
				...
				_antd.message.info('用户名及新密码不能为空 或 两次输入不一致');
			}
		}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'text', ref: 'username', placeholder: '\u8BF7\u8F93\u5165\u7528\u6237\u540D' }),
				_react2.default.createElement('span', { className: 'signin_xian' }),
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_antd.Pagination, { defaultPageSize: this.state.count, total: this.state.listAllData ? this.state.listAllData.total : 1, current: this.state.curPage, onChange: this.pageChange.bind(this) })
        )
      );
    }
  }, {
    ...
    value: function indexVideo(list) {
      ...
      return list.map(function (value, index) {
        if (index < 8) {
          return _react2.default.createElement(
            'div',
            { onClick: _this2.push.bind(_this2, value.id, value.url), className: 'index_vedio' },
            _react2.default.createElement(
              'dl',
              null,
              _react2.default.createElement(
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { className: 'list' },
          _react2.default.createElement(_antd.Table, { columns: this.state.columns, dataSource: this.state.filterData, pagination: false }),
          _react2.default.createElement(_antd.Pagination, { defaultPageSize: this.state.count, defaultCurrent: 1, total: this.state.total ? this.state.total : 1, onChange: this.pageChange.bind(this) })
        )
      );
    }
  }, {
...
var SearchContent = function (_Component) {
  ...
  _createClass(SearchContent, [{
    ...
    value: function setColumns(str) {
      ...
      var columns = [{
        ...
        render: function render(text, record) {
          return _react2.default.createElement(
            'span',
            { className: 'search_inner', onClick: _this2.goto.bind(_this2, record.id, record.city, record.url, str) },
            _react2.default.createElement(
              'div',
    ...
    key: 'goto',
    value: function goto(id, city, url, str) {
      ...
      if (this.props.dataSource) {
        List = this.props.dataSource.map(function (value, index) {
          return (
            ...
            _react2.default.createElement(
              'a',
              { href: value.url, className: 'video_wrap' },
              _react2.default.createElement(
                'dl',
                null,
                _react2.default.createElement(
