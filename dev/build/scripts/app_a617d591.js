...
var _in = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/admin/interviewq/in\""); e.code = 'MODULE_NOT_FOUND';; throw e; }()));
  ...
  _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { path: 'interviewq' },
        _react2.default.createElement(_reactRouter.IndexRedirect, { to: '/job/list' }),
        _react2.default.createElement(_reactRouter.Route, { path: 'detail/:id', component: _in2.default })
      ),
      _react2.default.createElement(
        _reactRouter.Route,
        { path: 'search' },
